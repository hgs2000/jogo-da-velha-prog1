...
public class EscolhaPlayerVsIA extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EscolhaPlayerVsIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EscolhaPlayerVsIA dialog = new EscolhaPlayerVsIA(new javax.swing.JFrame(), true);
